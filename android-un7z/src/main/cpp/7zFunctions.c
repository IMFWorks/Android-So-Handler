...
void CallJavaStringStringLongMethod(JNIEnv *env, jobject obj, jmethodID id, char *str1, char *str2,
                                    jlong paramLong) {
    if (id != NULL) {
        jstring jstring1 = (*env)->NewStringUTF(env, str1);
        jstring jstring2 = (*env)->NewStringUTF(env, str2);
        (*env)->CallVoidMethod(env, obj, id, jstring1, jstring2, paramLong);
